...
class BankNameTest extends TestCase
{
    ...
    {
        $this->finder = new BankName(__DIR__ . '/data');
    }
    ...
    {
        $this->assertEquals('Bundesbank', $this->finder->byBankleitzahl('10000000'));
    }
    ...
    {
        return [
            'IBAN' => ['DE00100000001234567890', 'Bundesbank'],
            'IBAN without Account' => ['DE0010000000', 'Bundesbank'],
        ];
    }
}
